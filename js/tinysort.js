...
function sortOut(sortering) {


    if ( ( sortering == '' ) ||  ( sortering == 'thema' ) ) {
		tinysort('div#cardflex>section',{attr:'data-thema'});
	}    
	else {
		

	    if ( sortering == 'volgorde' ) {
			tinysort('div#cardflex>section',{attr:'data-volgorde'});
		}    
		else {
			tinysort('div#cardflex>section',{attr:'data-tipnummer'});
		}
	}
